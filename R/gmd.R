...
gmd <- function(variables = NULL, country = NULL, version = NULL, 
  ...
  if (vars) {
    ...
    var_descriptions <- list(
      ...
      "finv_USD" = "Fixed Investment in USD",
      ...
      "gen_govexp_GDP" = "General gentral government Expenditure as % of GDP",
      ...
      "govrev" = "Consolidated government Revenue",
      "govrev_GDP" = "Government Revenue as % of GDP",
      "govtax" = "Consolidated government Tax Revenue",
      ...
      "govdef" = "Consolidated government Deficit",
      ...
      "govdebt" = "Consolidated government Debt",
